...
namespace CampingAI.Infra.Models.CAMPING_AI_DB;

public partial class CAMPINGAI_TTContext : DbContext
{
    public CAMPINGAI_TTContext(DbContextOptions<CAMPINGAI_TTContext> options)
        : base(options)
    {
    }
